...
<body>
	...
	<table width="800px" align="center" style="text-align: center;"
		...
		<tr>
			<td width="500px"><jsp:include page="/front/jsp/ftop.jsp"></jsp:include>

				<table border="0" height="670px">
					<tr>
						<td style="vertical-align: top; padding-top: 40px;"><jsp:include
								page="/front/jsp/userCenter/myOrder.jsp"></jsp:include></td>
