...
document.writeln("border:0;/*background:url(/EEpro/kf/images/top.gif) no-repeat center center*/");
document.writeln("}");
...
document.writeln("	BACKGROUND: url(/EEpro/kf/images/top.gif); HEIGHT: 76px");
document.writeln("}");
...
document.writeln("	BACKGROUND: url(/EEpro/kf/images/bottom.gif); HEIGHT: 51px; OVERFLOW: hidden");
document.writeln("}");
...
document.write("&nbsp;<img src=/EEpro/kf/images/kf_qq.gif height=17 border=0 align=middle>&nbsp;&nbsp;<a class='qqa' target=blank href='tencent://message/?uin=807788969&Site=http://localhost:8096/EEpro&Menu=yes' title='在线即时交谈[客服]'><font color=#000000>客服一</font></a>");

document.write('</td></tr><tr><td height=25>')

document.write("&nbsp;<img src=/EEpro/kf/images/kf_qq.gif height=17 border=0 align=middle>&nbsp;&nbsp;<a class='qqa' target=blank href='tencent://message/?uin=630930869&Site=http://localhost:8096/EEpro&Menu=yes' title='在线即时交谈[客服]'><font color=#000000>客服二</font></a>");
...
document.writeln("<div style=\'float:right;width:24px;margin:9px 0 0 0;border: 0px;\'><img id=menutop onMouseOver=\"javascript:ChangeMenu('RightMenu',115,500)\" border=0 height=100 src=/EEpro/kf/images/kefu.gif width=24></div>");
document.writeln("  </div></div>")
...
function ChangeMenu(id,menuwidth,menuheight){
    ...
    if(o.style.display == "none"){
        ...
        document.getElementById("menutop").src="/EEpro/kf/images/close.gif";
    }else{
        document.getElementById("menutop").src="/EEpro/kf/images/kefu.gif";
