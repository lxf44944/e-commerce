...
<body>
	<form method="post" action="AdminServlet?task=update&suser=${requestScope.bean.user}" name="sform"
		onsubmit="return checkSform();">
		<table width=800 height=100 border=0 cellpadding=5 align="center">
			<caption
				style="font-size: 20px;padding-bottom: 20px;padding-top: 30px">管理员资料修改</caption>
			<tr>
				<td>用&nbsp;户&nbsp;名： <input type="text" disabled="disabled"
					name="suser" value="${requestScope.bean.user}" maxlength=30 /> <span
					id="suserSp"></span></td>
			</tr>
			...
			<tr>
				<td>性&nbsp;&nbsp;&nbsp;&nbsp;别： <input type="radio" name="sex"
					...
					${requestScope.bean.sex=="男"?"checked":""} /> 男
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="sex" value="女"
					${requestScope.bean.sex=="女"?"checked":"" }
					style="width:50px;" /> 女</td>
			</tr>
			<tr>
				<td>真实姓名： <input type="text" name="sname" maxlength=30
					value="${requestScope.bean.name }" /> <span id="snameSp" /></span></td>
			</tr>
			<tr>
				<td>出生日期： <input type="text" name="sdate" size="30"
					value="${requestScope.bean.birth }"
					onfocus="javascript:{show_cele_date(this,'','',this);}" /> <span
					id="sdateSp"></span></td>
			</tr>
			<tr>
				<td>电子邮箱： <input type="text" name="semail" maxlength=30
					value="${requestScope.bean.email }" /> <span id="semailSp"></span>
				</td>
			</tr>
			<tr>
				<td>电话号码： <input type="text" name="snumber" maxlength=30
					value="${requestScope.bean.tel }" /> <span id="snumberSp"></span></td>
			</tr>
			<tr>
				<td>地&nbsp;&nbsp;&nbsp;&nbsp;址： <input type="text"
					value="${requestScope.bean.adress }" name="sadress" maxlength=30 />
					<span id="sadressSp"></span></td>
			</tr>
			<tr>
				<td>邮&nbsp;&nbsp;&nbsp;&nbsp;编： <input type="text"
					value="${requestScope.bean.postcode }" name="spostcode"
