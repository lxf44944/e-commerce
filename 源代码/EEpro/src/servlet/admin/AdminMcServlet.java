...
public class AdminMcServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (data.get("simg") != null && "".equals(data.get("simg"))) {
			simg = "NoGood.gif";
		} else {
			simg = data.get("simg");
		}
		...
		mcBean.setNmaxid(data.get("nmaxid"));
			...
			mcDao.delMc(sid);
			response.sendRedirect(request.getContextPath() + "/BackMcServlet");
		}
