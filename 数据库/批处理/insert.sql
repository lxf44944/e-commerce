insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf001','lxf001','刘向峰1','男','1992-01-01','lxf_44911@163.com','12345678','山西大同一','037001');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf002','lxf002','刘向峰2','女','1992-02-02','lxf_44922@163.com','12345678','山西大同二','037002');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf003','lxf003','刘向峰3','男','1992-03-03','lxf_44933@163.com','12345678','山西大同三','037003');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf004','lxf004','刘向峰4','女','1992-04-04','lxf_44944@163.com','12345678','山西大同四','037004');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf005','lxf005','刘向峰5','男','1992-05-05','lxf_44955@163.com','12345678','山西大同五','037005');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf006','lxf006','刘向峰6','男','1992-06-01','lxf_44966@163.com','12345678','山西大同六','037006');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf007','lxf007','刘向峰7','女','1992-07-02','lxf_44977@163.com','12345678','山西大同七','037007');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf008','lxf008','刘向峰8','男','1992-08-03','lxf_44988@163.com','12345678','山西大同八','037008');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf009','lxf009','刘向峰9','女','1992-09-04','lxf_44999@163.com','12345678','山西大同九','037009');
insert into t_user(suser,pass,name,sex,birth,email,tel,address,postcode) values ('lxf000','lxf000','刘向峰0','男','1992-10-05','lxf_44900@163.com','12345678','山西大同十','037000');
...
insert into t_order(nid,scuser,dgdate,spaytype,ssendtype,nmctypesize,nmcsize,ntotalprice ,sstatus,ssname,ssaddress ,sscode,ssphone ,ssemail )values(seq_t_order.nextval,'lxf001',sysdate,'网银支付','直接付款','2','4','1996.0','1','刘向峰1','山西大同1','037001','12345678','lxf_44941@163.com')
insert into t_order(nid,scuser,dgdate,spaytype,ssendtype,nmctypesize,nmcsize,ntotalprice ,sstatus,ssname,ssaddress ,sscode,ssphone ,ssemail )values(seq_t_order.nextval,'lxf002',sysdate,'网银支付','直接付款','3','4','1199.0','1','刘向峰2','山西大同2','037002','12345678','lxf_44942@163.com')
insert into t_order(nid,scuser,dgdate,spaytype,ssendtype,nmctypesize,nmcsize,ntotalprice ,sstatus,ssname,ssaddress ,sscode,ssphone ,ssemail )values(seq_t_order.nextval,'lxf003',sysdate,'网银支付','直接付款','2','4','11996.0','1','刘向峰3','山西大同3','037003','12345678','lxf_44943@163.com')
insert into t_order(nid,scuser,dgdate,spaytype,ssendtype,nmctypesize,nmcsize,ntotalprice ,sstatus,ssname,ssaddress ,sscode,ssphone ,ssemail )values(seq_t_order.nextval,'lxf004',sysdate,'网银支付','直接付款','3','4','11880.0','1','刘向峰4','山西大同4','037004','12345678','lxf_44944@163.com')
insert into t_order(nid,scuser,dgdate,spaytype,ssendtype,nmctypesize,nmcsize,ntotalprice ,sstatus,ssname,ssaddress ,sscode,ssphone ,ssemail )values(seq_t_order.nextval,'lxf005',sysdate,'网银支付','直接付款','2','4','41996.0','1','刘向峰5','山西大同5','037005','12345678','lxf_44945@163.com')
